...
const DashboardProduct = () => {
    return (
        <div>
            ...
            <div class="sm:col-span-3">
                <label for="last-name" class="block text-sm font-medium leading-6 text-gray-900">Product Title</label>
                <div class="mt-2">
            ...
            <div class="sm:col-span-3">
                ...
                <div class="sm:col-span-3">
                <label for="last-name" class="block text-sm font-medium leading-6 text-gray-900">Product Rating</label>
                <div class="mt-2">
                    <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full py-2 rounded-md border-2 border-gray-200 outline-none focus:border-indigo-500"/>
                </div>
          </div>
          ...
          <div class="mt-2">
            <select id="country" name="country" autocomplete="country-name" class="block w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
  ...
  <input type="file" name="file-input" id="file-input" class="block w-full border border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400
    ...
    dark:file:bg-gray-700 dark:file:text-gray-400"/>
                ...
                <input className='btn bg-indigo-600 py-2 px-4 rounded-md text-white w-full mt-4' value="Add Product" type="submit" />
            </form>
            </div>
        </div>
        </div>
