...
const Dashboard = () => {  
  ...
  return (
    ...
    <div>
        ...
        <div className="flex w-full flex-wrap items-center justify-between px-3">
          <div className="ml-2">
            <div className='flex justify-center '>
              <a href="#">
                <img className="w-auto h-14 sm:h-7" src={logo} alt="" />
              </a>
            ...
            >
              ...
              >
                ...
                <li className="my-4 pl-2 lg:my-0 lg:pl-2 lg:pr-1" data-te-nav-item-ref>
                  ...
                  <Link to={'/dashboard/account'} className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                  ...
                  <Link to={'/dashboard/category'} className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <aside className="flex flex-col w-52 px-4 py-8 overflow-y-auto bg-white dark:bg-gray-900 dark:border-gray-700">
